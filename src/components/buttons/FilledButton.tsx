...
export default function FilledButton({
  ...
  return (
    <button
      ...
      disabled={isDisabled}
      className={`flex gap-2 px-6 py-2 rounded-full font-semibold text-neutral-0 transition-all justify-center duration-500 disabled:bg-neutral-10 disabled:border disabled:border-neutral-300 disabled:text-neutral-50 disabled:bg-none ${
        type === WidgetTypes.PRIMARY
